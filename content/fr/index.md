...
---
  ...
  title: Tourisme & attractivité
  ---
  Offices de tourisme, destinations et stations thermales — valorisez hébergements, restaurants, activités et balades sur une carte enrichie depuis vos SIT (Sirtaqui, Apidae, Tourinsoft).
  ::
  ...
  ---
  Communes, intercommunalités et départements — informez vos habitants sur les services publics, commerces, mobilités et ressources de votre territoire.
  ::
  ...
  ---
  Pays et territoires — mettez en valeur vos producteurs locaux, marchés et routes gourmandes pour dynamiser la consommation de proximité.
  ::
  ...
  title: Santé
  ---
  CPTS et structures de santé — facilitez l'accès aux professionnels de santé de votre territoire grâce à un annuaire cartographique interactif.
  ::
...
---
headline: Références
title: 30+ organisations déploient CartoGuide
description: "Du tourisme à la santé, des collectivités aux circuits courts — des acteurs du territoire de toute la France font confiance à CartoGuide."
...
---
  ...
  title: Grand Dax Tourisme & Thermalisme
  ---
  Carte des hébergements, restaurants et soins thermaux de la station landaise.
  ::
  ...
  ---
  Destination catalane — mise en valeur du patrimoine et des offres touristiques.
  ::

  ::landing-reference
  ---
  logo: https://elasa.teritorio.xyz/assets/6aec32f1-28cb-4d28-9914-d213ac3d4ec2/Logo_Sud_Tourisme_2022_final.jpg
  title: Province Sud — Nouvelle-Calédonie
  ---
  Carte officielle du tourisme en province Sud, à l'autre bout du monde.
  ::

  ::landing-reference
  ---
  logo: https://elasa.teritorio.xyz/assets/d142126a-402c-4092-a5a2-38143d77f158/logo_oti.png
  title: CINOR — La Réunion
  ---
  Exploration des sites naturels et culturels du nord de l'île de La Réunion.
  ::

  ::landing-reference
  ---
  logo: https://elasa.teritorio.xyz/assets/cf4e44bb-e585-3395-87b7-ff07dc0220dd/pastille-1.png
  title: Ville de Bègles
  ---
  Carte des services, équipements et commerces de la commune girondine.
  ::
  ...
  ---
  Carte des ressources économiques et touristiques du territoire aubois.
  ::
  ...
  ---
  Annuaire cartographique des producteurs locaux et circuits courts du territoire.
  ::
  ...
  ---
  Annuaire interactif des professionnels de santé du Seignanx et de Bayonne.
  ::
...
title: CartoGuide par Teritorio
ctaLabel: Demander une démo
ctaTo: /contact
---
CartoGuide est un logiciel libre, mais le déployer efficacement demande du temps et une expertise technique. Teritorio propose un accompagnement complet, de l'hébergement à la formation, pour que vous puissiez vous concentrer sur votre territoire.

**SaaS hébergé** — CartoGuide déployé, maintenu et mis à jour par Teritorio. Zéro infrastructure à gérer : vous accédez à votre carte via un simple navigateur, Teritorio s'occupe de tout le reste.

**Accompagnement au déploiement** — Configuration sur mesure de vos sources de données (SIT touristiques, Geotrek, Open Agenda, back-office métier), personnalisation de l'interface aux couleurs de votre territoire et formation de vos équipes.

**Développements spécifiques** — Nouvelles fonctionnalités, intégrations métier, adaptations selon vos besoins : Teritorio contribue en retour au logiciel libre pour que toute la communauté en bénéficie.
::
